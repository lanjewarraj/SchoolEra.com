...
$rtr="select * from subject where id='".$_POST['txtID']."'";
	...
	<div class="card card-register mx-auto mt-10">
      ...
      <div class="card-body">
        <form action="updatesub.php" method="post">
                ...
                <input class="form-control" name="txtsubjectname" id="subjectname" type="text" aria-describedby="nameHelp" value=<?php echo $r1; ?> required>
              
                <label for="classroomno">Subjectcode</label>
                <input class="form-control" id="subjectcode" type="text" aria-describedby="nameHelp" name="txtsubjectcode"  value=<?php echo $r2; ?> required>
              
			    
			  
                <label for="teacheralloted">TeacherAlloted</label>
                <input class="form-control" id="teacheralloted" type="text" aria-describedby="nameHelp"  name="txtteacheralloted"  value=<?php echo $r3; ?> required><br>
                
			  
			  
		 
		 <input type=hidden name="txtid" value="<?php echo $r0 ?>" ><br>
