...
?>
<?php
$conn=mysqli_connect('localhost','root','','MySchol');
$rtr="select * from info where id='".$_POST['txtID']."'";
      ...
      <ul  style="background-color:black;" class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages2">
            <li>
              <a href="AddMarks.php">AddResult</a>
            </li>
            <li>
	...
	<div class="card card-register mx-auto mt-10">
      ...
      <div class="card-body">
        <form action="updatestaff.php" method="post">
                ...
                <input class="form-control" name="fname" id="fullname" type="text" aria-describedby="nameHelp" value=<?php echo $r1; ?>>
              
                <label for="gender">Gender</label>
                <input class="form-control" id="gender" type="text" aria-describedby="nameHelp" name="gender"  value=<?php echo $r2; ?>>
              
			  
                <label for="email">Email</label>
                <input class="form-control" id="email" type="text" aria-describedby="nameHelp"  name="email"  value=<?php echo $r3; ?>><br>
                 
				 <label for="mobile">Mobile</label>
                <input class="form-control" id="mobile" type="text" aria-describedby="nameHelp"  name="mobile"  value=<?php echo $r4; ?>><br>
				  
				  <label for="address">Address</label>
                <input class="form-control" id="address" type="text" aria-describedby="nameHelp"  name="address"  value=<?php echo $r5; ?>><br>
				      
				 <label for="city">City</label>
                <input class="form-control" id="city" type="text" aria-describedby="nameHelp"  name="city"  value=<?php echo $r6; ?>><br>
				  
				  <label for="date">Date</label>
                <input class="form-control" id="date" type="text" aria-describedby="nameHelp"  name="date"  value=<?php echo $r7; ?>><br>
			  
			  <input type=hidden name="txtid" value="<?php echo $r0 ?>">
         <Button type="submit" name="cmd" class="btn btn-primary btn-block">Submit</button> <br/>
        </form>
        </div>
    </div>
  </div>
