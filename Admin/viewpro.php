      ...
      <div class="card-body">
	     <center>
		  ...
		  <label></label>
		   ...
		   <label>Email</label>
		   <input class="form-control" type="text" value="<?php echo $r4; ?>"name="txtEmail" readonly>
		   <label>Application No</label>
		   <input class="form-control" type="text" value="<?php echo $r1; ?>"name="txtApp" readonly>
		   <label>RollNo</label>
		   <input class="form-control" type="text" value="<?php echo $r2; ?>" name="txtroll" readonly>
		    <label>Class</label>
		   <input class="form-control" type="text" value="<?php echo $r3; ?>" name="txtclass" readonly>		   
        </div>
    </div>
  </div>
