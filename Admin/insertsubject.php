...
<html>
<head>
<title> insert data in subject </title>
      ...
      <ul  style="background-color:black;" class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages2">
            <li>
              <a href="AddResult.php">Upload Marks</a>
            </li>
            <li>
              <a href="ManageResult.php">View Marks</a>
            </li>
          </ul>
        </li>
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
...
<label>SUBJECTNAME:</label>  <input class="form-control" type="text" name="subjectname" required>
<label>SUBJECTCODE:</label>  <input class="form-control" type="text" name="subjectcode" required>
<label>TEACHERALLOTED:</label>  <input class="form-control" type="text" name="teacheralloted" required><br>
<input class="btn btn-primary btn-block" type="submit" value="Insert"><br/>
