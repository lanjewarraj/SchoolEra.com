  ...
  <body>
    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
	   ...
	   <h1 class="form-signin-heading">TEACHER LOGIN</h1>
       <form action="teachlogin.php" method="post" class="form-signin">
	   <select onchange="javascript:handleSelect(this)" class="form-control" name="type"><option value="teacherlog">TEACHERS</option><option value="Administrator">ADMIN</option></select><br>
	   ...
	   <a href="newteacher.php">Create new Account?</a>
	   </form>
