...
$rtr="select * from class where cid='".$_POST['txtID']."'";
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
	...
	<div class="card card-register mx-auto mt-10">
      ...
      <div class="card-body">
        <form action="updatecls.php" method="post">
	
                <label for="classroomno">CLASSROOMNO</label>
                <input class="form-control" name="txtclassroomno" id="classroomno" type="text" aria-describedby="nameHelp" value=<?php echo $r1; ?> required>
              
              
                <label for="#">Class Teacher</label>
                <input class="form-control" id="section" type="text" aria-describedby="nameHelp" name="teach"  value=<?php echo $r2; ?> required>
             
			  
			    
			   
                <label for="#">Class</label>
                <input class="form-control" id="nos" type="text" aria-describedby="nameHelp"  name="Class"  value=<?php echo $r3; ?> required>
              </div>  
			  <div>
			  
		
		 <input type=hidden name="txtcid" value="<?php echo $r0 ?>"><br>
